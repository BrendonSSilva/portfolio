...
export const Card1 = () => {
  ...
  return (
    <section className="page card-1-page">
      ...
      <div className="btns">
        <button className="button-default" style={{ marginTop: "50px" }}>
          <a href="https://www.linkedin.com/in/brendon-silva/">
            <img src="/icons/cta-icon.svg" alt={t.card1.contact} />
            {t.card1.contact}
          </a>
        </button>
        <Link to="/" className="btn-link">
