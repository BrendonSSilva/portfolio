    ...
    <section className="hero">
      ...
      >
        ...
        <div className="hero-ctas">
          <a
            href="https://www.linkedin.com/in/brendon-silva/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://github.com/BrendonSSilva"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="code-window">
          ...
          <pre className="code-body">
            <code>
              ...
              <span className="code-prop">ai</span>: [
              <span className="code-string">"Claude API"</span>,{" "}
              <span className="code-string">"GPT-4"</span>],{"\n"}{" "}
              <span className="code-prop">founder</span>:{" "}
