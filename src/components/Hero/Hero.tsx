        ...
        <>
            <section className="hero">
                <div className='hero-left'>
                    ...
                    <button className="button-default"><a href="https://www.linkedin.com/in/brendon-silva/"><img src="/icons/cta-icon.svg" alt='Contato' width="20" height="20" loading="lazy"/>Contato</a></button>
                </div>
                <div className='hero-right'>
                    <img src='/imgs/code-hero.webp' alt='Brendon Silva Informações' />
                </div>
            </section>
        </>
    );
